...
const MemoryEngine = lazy(() => import('@/pages/MemoryEngine'));
const CognitiveEngine = lazy(() => import('@/pages/CognitiveEngine'));
const MriValidation = lazy(() => import('@/pages/MriValidation'));
const MqccsValidation = lazy(() => import('@/pages/MqccsValidation'));
const MpegsGovernance = lazy(() => import('@/pages/MpegsGovernance'));
...
const Sprint1Review = lazy(() => import('@/pages/Sprint1Review'));
...
const Sprint1WME = lazy(() => import('@/pages/Sprint1WME'));
const ReviewEngineRegistryPage = lazy(() => import('@/pages/ReviewEngineRegistry'));
const Capabilities = lazy(() => import('@/pages/Capabilities'));
const Journeys = lazy(() => import('@/pages/Journeys'));
const Goals = lazy(() => import('@/pages/Goals'));
const Planner = lazy(() => import('@/pages/Planner'));
const PlanningIntelligence = lazy(() => import('@/pages/PlanningIntelligence'));
const SpecialistRouterPage = lazy(() => import('@/pages/SpecialistRouter'));
const StrategyFusion = lazy(() => import('@/pages/StrategyFusion'));
...
const ABVPage = lazy(() => import('@/pages/ABVPage'));
const ABVSprintPage = lazy(() => import('@/pages/ABVSprintPage'));
const FCESprintPage = lazy(() => import('@/pages/FCESprintPage'));
const GoalRuntimePage = lazy(() => import('@/pages/GoalRuntimePage'));
const GoalRegistryServicePage = lazy(() => import('@/pages/GoalRegistryServicePage'));
const GoalSchedulerPage = lazy(() => import('@/pages/GoalSchedulerPage'));
const GoalExecutionQueuePage = lazy(() => import('@/pages/GoalExecutionQueuePage'));
const ExecutionDispatcherPage = lazy(() => import('@/pages/ExecutionDispatcherPage'));
const DecisionEnginePage = lazy(() => import('@/pages/DecisionEnginePage'));
const PlanningEnginePage = lazy(() => import('@/pages/PlanningEnginePage'));
const ReflectionEnginePage = lazy(() => import('@/pages/ReflectionEnginePage'));
const SelfEvaluationEnginePage = lazy(() => import('@/pages/SelfEvaluationEnginePage'));
const KnowledgeEnginePage = lazy(() => import('@/pages/KnowledgeEnginePage'));
const LearningEnginePage = lazy(() => import('@/pages/LearningEnginePage'));
const MemoryEnginePage = lazy(() => import('@/pages/MemoryEnginePage'));
const RetrievalEnginePage = lazy(() => import('@/pages/RetrievalEnginePage'));
const CognitivePipeline = lazy(() => import('@/pages/CognitivePipeline'));
const CapabilityRegistryPage = lazy(() => import('@/pages/CapabilityRegistryPage'));
const CognitivePipelineAdapterPage = lazy(() => import('@/pages/CognitivePipelineAdapterPage'));
...
const EF36IPage = lazy(() => import('@/pages/EF36IPage'));
...
const Beta03Page = lazy(() => import('@/pages/Beta03Page'));
const Beta031Page = lazy(() => import('@/pages/Beta031Page'));
const Beta032Page = lazy(() => import('@/pages/Beta032Page'));
const Beta033Page = lazy(() => import('@/pages/Beta033Page'));
const Phase5Page = lazy(() => import('@/pages/Phase5Page'));
const Phase51Page = lazy(() => import('@/pages/Phase51Page'));
const Phase52Page = lazy(() => import('@/pages/Phase52Page'));
const OperationalAuditPage = lazy(() => import('@/pages/OperationalAuditPage'));
const Phase53Page = lazy(() => import('@/pages/Phase53Page'));
const CoreValidationReportPage = lazy(() => import('@/pages/CoreValidationReportPage'));
...
const Phase570Page = lazy(() => import('@/pages/Phase570Page'));
...
const Phase59Page = lazy(() => import('@/pages/Phase59Page'));
...
const Phase610Page = lazy(() => import('@/pages/Phase610Page'));
const Phase611Page = lazy(() => import('@/pages/Phase611Page'));
const Phase620Page = lazy(() => import('@/pages/Phase620Page'));
const Phase621Page = lazy(() => import('@/pages/Phase621Page'));
const Phase622Page = lazy(() => import('@/pages/Phase622Page'));
const Phase623Page = lazy(() => import('@/pages/Phase623Page'));
const Phase624Page = lazy(() => import('@/pages/Phase624Page'));
const Phase630Page = lazy(() => import('@/pages/Phase630Page'));
const Phase631Page = lazy(() => import('@/pages/Phase631Page'));
const Phase632Page = lazy(() => import('@/pages/Phase632Page'));
const Phase633Page = lazy(() => import('@/pages/Phase633Page'));
const Phase634Page = lazy(() => import('@/pages/Phase634Page'));
const Phase635Page = lazy(() => import('@/pages/Phase635Page'));
const Phase640Page = lazy(() => import('@/pages/Phase640Page'));
const Phase641Page = lazy(() => import('@/pages/Phase641Page'));
const Phase641aPage = lazy(() => import('@/pages/Phase641aPage'));
const Phase642Page = lazy(() => import('@/pages/Phase642Page'));
const Phase642aPage = lazy(() => import('@/pages/Phase642aPage'));
const Phase643Page = lazy(() => import('@/pages/Phase643Page'));
const Phase710Page = lazy(() => import('@/pages/Phase710Page'));
...
const Phase713Page = lazy(() => import('@/pages/Phase713Page'));
const Phase714Page = lazy(() => import('@/pages/Phase714Page'));
...
const CertificationCenterPage = lazy(() => import('@/pages/CertificationCenterPage'));
const Sprint811Page = lazy(() => import('@/pages/Sprint811Page'));
const Sprint812Page = lazy(() => import('@/pages/Sprint812Page'));
const SprintC022Page = lazy(() => import('@/pages/SprintC022Page'));
const SprintC023Page = lazy(() => import('@/pages/SprintC023Page'));
const SprintC024Page = lazy(() => import('@/pages/SprintC024Page'));
const SprintC030Page = lazy(() => import('@/pages/SprintC030Page'));
const SprintC036Page = lazy(() => import('@/pages/SprintC036Page'));
const SprintC0361Page = lazy(() => import('@/pages/SprintC0361Page'));
const SprintC0363Page = lazy(() => import('@/pages/SprintC0363Page'));
const SprintC0364Page = lazy(() => import('@/pages/SprintC0364Page'));
const SprintC040Page = lazy(() => import('@/pages/SprintC040Page'));
const SprintP011APage = lazy(() => import('@/pages/SprintP011APage'));
const SprintP011BPage = lazy(() => import('@/pages/SprintP011BPage'));
const SprintP011CPage = lazy(() => import('@/pages/SprintP011CPage'));
const AVPPage = lazy(() => import('@/pages/AVPPage'));
...
const SprintEF660Page = lazy(() => import('@/pages/SprintEF660Page'));
const SprintEF661Page = lazy(() => import('@/pages/SprintEF661Page'));
const SprintEF670Page = lazy(() => import('@/pages/SprintEF670Page'));
const Phase720Page = lazy(() => import('@/pages/Phase720Page'));
const Phase730Page = lazy(() => import('@/pages/Phase730Page'));
const SprintP020Page = lazy(() => import('@/pages/SprintP020Page'));
const SprintP021Page = lazy(() => import('@/pages/SprintP021Page'));
const BetaSprint01Page = lazy(() => import('@/pages/BetaSprint01Page'));
const SprintOL01Page = lazy(() => import('@/pages/SprintOL01Page'));
const SprintOL02Page = lazy(() => import('@/pages/SprintOL02Page'));
const PhaseKB01Page = lazy(() => import('@/pages/PhaseKB01Page'));
const PhaseKB02Page = lazy(() => import('@/pages/PhaseKB02Page'));
const PhaseKB03Page = lazy(() => import('@/pages/PhaseKB03Page'));
const PhaseKB04Page = lazy(() => import('@/pages/PhaseKB04Page'));
const PhaseKB05Page = lazy(() => import('@/pages/PhaseKB05Page'));
const PhaseIntegration01Page = lazy(() => import('@/pages/PhaseIntegration01Page'));
const PhaseIntegration02Page = lazy(() => import('@/pages/PhaseIntegration02Page'));
const PhaseIntegration03Page = lazy(() => import('@/pages/PhaseIntegration03Page'));
const PhaseIntegration04Page = lazy(() => import('@/pages/PhaseIntegration04Page'));
const PhaseIntegration05Page = lazy(() => import('@/pages/PhaseIntegration05Page'));
const PlatformAuditPage = lazy(() => import('@/pages/PlatformAuditPage'));
const PhaseEV1Page = lazy(() => import('@/pages/PhaseEV1Page'));
const PhaseEV2Page = lazy(() => import('@/pages/PhaseEV2Page'));
const PhaseEV4Page = lazy(() => import('@/pages/PhaseEV4Page'));
const PhaseEV4BPage = lazy(() => import('@/pages/PhaseEV4BPage'));
const PhaseEV5Page = lazy(() => import('@/pages/PhaseEV5Page'));
const ProductionDashboard = lazy(() => import('@/pages/ProductionDashboard'));
const PhaseEF36Page = lazy(() => import('@/pages/PhaseEF36Page'));
...
const PhaseEF39Page = lazy(() => import('@/pages/PhaseEF39Page'));
const PhaseEF393Page = lazy(() => import('@/pages/PhaseEF393Page'));
const EF398CertPage = lazy(() => import('@/pages/EF398CertPage'));
...
const SprintEF428Page = lazy(() => import('@/pages/SprintEF428Page'));
const SprintEF429Page = lazy(() => import('@/pages/SprintEF429Page'));
...
const SprintEF45Page = lazy(() => import('@/pages/SprintEF45Page'));
const SprintEF46Page = lazy(() => import('@/pages/SprintEF46Page'));
const SprintEF47Page = lazy(() => import('@/pages/SprintEF47Page'));
const SprintEF48Page = lazy(() => import('@/pages/SprintEF48Page'));
const SprintEF49Page = lazy(() => import('@/pages/SprintEF49Page'));
const SprintEF491Page = lazy(() => import('@/pages/SprintEF491Page'));
const SprintEF492Page = lazy(() => import('@/pages/SprintEF492Page'));
const SprintEF51Page = lazy(() => import('@/pages/SprintEF51Page'));
const SprintEF52Page = lazy(() => import('@/pages/SprintEF52Page'));
const SprintEF53Page = lazy(() => import('@/pages/SprintEF53Page'));
const SprintEF54Page = lazy(() => import('@/pages/SprintEF54Page'));
const SprintEF555Page = lazy(() => import('@/pages/SprintEF555Page'));
const ArchitecturalCertPage = lazy(() => import('@/pages/ArchitecturalCertPage'));
const SprintEF554RecertPage = lazy(() => import('@/pages/SprintEF554RecertPage'));
const SprintEF56OperationalCertPage = lazy(() => import('@/pages/SprintEF56OperationalCertPage'));
...
const SprintEF60APage = lazy(() => import('@/pages/SprintEF60APage'));
const SprintEF60BPage = lazy(() => import('@/pages/SprintEF60BPage'));
const SprintMVP01Page = lazy(() => import('@/pages/SprintMVP01Page'));
    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute unauthenticatedElement={<Navigate to="/login" replace />} />}>
        <Route element={<AppLayout />}>
          ...
          <Route path="/sprint-ef60a" element={<SprintEF60APage />} />
