/**
 * ConnectorAuthCenter — Autenticação e monitoramento de conectores
 *
 * RESTAURADA — antes era "Phase570Page", apagada por engano numa limpeza
 * de codigo morto por nao ter nenhum link vindo de pagina real (so era
 * alcancada por URL direta). Renomeada e agora linkada de verdade a
 * partir de Connections.jsx pra nao acontecer de novo.
...
export default function ConnectorAuthCenter() {
