...
const CAT_COLOR = {
  ...
  GRAPH: "teal", WORKFLOW: "orange", BASELINE: "red", MEMORY: "green", UCP: "violet", SHR: "orange", EAF: "violet", AEL: "orange", PSM: "green",
};
...
const CATEGORIES = ["KG", "PIPELINE", "ROUTING", "CONNECTOR", "GRAPH", "WORKFLOW", "BASELINE", "MEMORY", "UCP", "SHR", "EAF", "AEL", "PSM"];
