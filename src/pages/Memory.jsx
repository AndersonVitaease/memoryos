              ...
              <div key={d.id} className="bg-white rounded-xl border border-zinc-200/80 p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    {d.decided_date && <p className="text-xs text-zinc-400 mt-2">{safeFormat(d.decided_date, "dd/MM/yyyy")}</p>}
                  </div>
                </div>
              </div>
            ))
              ...
              <div key={t.id} className="flex items-center gap-3 bg-white rounded-xl border border-zinc-200/80 p-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-3 mt-1">
                    ...
                    {t.due_date && <span className="text-xs text-zinc-400">📅 {safeFormat(t.due_date, "dd/MM")}</span>}
                  </div>
                </div>
              </div>
            ))
