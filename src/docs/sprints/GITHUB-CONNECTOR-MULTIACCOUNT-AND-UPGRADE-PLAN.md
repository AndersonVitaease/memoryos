...
**Data:** 2026-08-04
**Status:** TODOS CONCLUÍDOS — Multi-conta · Upgrade 1 (Escritas) · Upgrade 2 (Token Bucket) · Upgrade 3 (Webhooks) · Upgrade 4 (Code Search proxy) · Upgrade 5 (Retry) · Upgrade 6 (Actions/Releases)
