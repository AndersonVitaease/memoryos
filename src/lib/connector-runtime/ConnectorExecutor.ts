...
import type { ConnectorContext, ConnectorResult, ExecutionRecord } from "./ConnectorTypes";
...
export class ConnectorExecutor {
  ...
  async execute(
    ...
    try {
      ...
      return { ...result, executionId, logs: [...logs, ...(result.logs ?? [])] };
      ...
      return { success: false, error, duration, connectorId: connector.id, executionId, logs };
    }
  }
