/**
 * DecisionKnowledgeProvider.ts
 * Fetches all relevant knowledge for a decision — exclusively via KnowledgeQueryFacade.
 *
 * SRP: Knowledge retrieval only.
 * Sprint: INTEGRATION-03
 *
 * Rule: NO direct Registry access. KnowledgeQueryFacade is the only gateway.
 */
...
export interface DecisionKnowledgeBundle {
...
export const DecisionKnowledgeProvider = Object.freeze({

  fetch(ctx: DecisionKnowledgeContext): DecisionKnowledgeBundle {
