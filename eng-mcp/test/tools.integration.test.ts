...
test("authenticated MCP endpoint exposes exactly the approved tools", async () => {
  ...
  try {
    ...
    assert.equal(catalog.actualToolCount, 106);
    assert.equal(catalog.catalogVersion, "eng-mcp-tools-v106");
